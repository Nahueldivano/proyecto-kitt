    ...
    <div className="border-t border-[hsl(var(--border))] bg-[hsl(var(--surface))] px-3 py-3">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="relative rounded-2xl border border-[hsl(var(--border-2))] bg-[hsl(var(--background))] focus-within:ring-2 focus-within:ring-[hsl(var(--accent))] focus-within:border-[hsl(var(--accent))] transition-all">
          ...
          {/* Toolbar inferior dentro del input */}
          <div className="absolute bottom-2 left-3 right-3 flex items-center justify-between">
              ...
              <button
                ...
                className={`p-1.5 rounded-lg transition-colors disabled:opacity-40 ${
                  webSearchEnabled
                    ...
                    : "text-[hsl(var(--text-3))] hover:text-[hsl(var(--text))] hover:bg-[hsl(var(--surface-2))]"
                }`}
              >
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Derecha: selector modelo + enviar */}
            <div className="flex items-center gap-2">
                  ...
                  <div className="absolute bottom-full mb-2 right-0 bg-[hsl(var(--surface))] border border-[hsl(var(--border))] rounded-xl shadow-xl py-1 w-64 z-50">
                    {AVAILABLE_MODELS.map((m) => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 hover:bg-[hsl(var(--surface-2))] transition-colors ${
                          m.id === selectedModel ? "bg-[hsl(var(--accent-soft))]" : ""
                        }`}
                      >
              ...
              {isStreaming ? (
                <button
                  type="button"
                  onClick={onCancel}
                  className="h-8 w-8 rounded-xl border border-red-500/40 text-red-500 hover:bg-red-500/10 flex items-center justify-center transition-colors"
                  aria-label="Cancelar"
                >
        ...
        <p className="hidden md:block text-center text-[10px] text-[hsl(var(--text-3))] mt-1.5">
